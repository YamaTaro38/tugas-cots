...
Aplikasi web manajemen inventory dengan sistem autentikasi (login/register) dan fitur CRUD (Create, Read, Update, Delete) untuk mengelola data produk. Dibangun menggunakan framework CodeIgniter 4 dengan pendekatan RESTful API.
...
Import file database.sql yang telah disediakan
...
Tabel data juga akan otomatis refresh tanpa perlu reload halaman.
